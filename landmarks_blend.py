...
if __name__ == '__main__':
    ...
    ret = np.array(landmarker.extract_lm478_from_video_name("data/joe_face.mp4"))
    print(ret.shape)
    np.save('real_lnd.npy', ret)

    new = np.array(landmarker.combine_vid_img_lm478_to_lm478(ret[0], ret[1]))
    print(new.shape)
    np.save('blend_lnd.npy', new)